            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                   <li class="active">
					 ...
					 <li class="active">
                        <a href="#"> <i class="menu-icon fa fa-dashboard"></i>CHANGE PASSWORD</a>
                    </li>
					 <li class="active">
                        <a href="#"> <i class="menu-icon fa fa-dashboard"></i>FEEDBACK</a>
                    </li>
   ...
   <!--    <div class="breadcrumbs">
	...
	-->		
		...
		<?php
															...
															mysql_select_db("pga");
													    	$oid=$_SESSION['OID'];
															$q="select * from owner_reg where OID='$oid'";
															$res=mysql_query($q);
...
<div class="col-lg-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="oeditprofile_action.php" method="post" enctype="multipart/form-data" class="form-horizontal">
												
                                                            <img class="rounded-circle mx-auto d-block" alt="Card image cap" src="ownerphoto/<?php echo $row['P_PHOTO']; ?>" width="150px" height="150px" alt=""/>
															 <div class="row form-group">
                                                                    <div class="col col-md-2"><label for="file-input" class=" form-control-label">EDIT IMAGE</label></div>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="FIRSTNAME" value="<?php echo $row['FIRSTNAME'];?>" class="form-control"></div>
                                                            </div>
                                                            
															 <div class="row form-group">
                                                                <div class="col col-md-2"><label for="text-input" class=" form-control-label">LAST NAME</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="LASTNAME" value="<?php echo $row['LASTNAME'];?>" class="form-control"></div>
                                                            </div>
                                                            
															 <div class="row form-group">
                                                                <div class="col col-md-2"><label for="text-input" class=" form-control-label">EMAIL</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="EMAIL" value="<?php echo $row['EMAIL'];?>" class="form-control"></div>
                                                            </div>
                                                            
															 <div class="row form-group">
                                                                <div class="col col-md-2"><label for="text-input" class=" form-control-label">MOBILENO</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="MOBILENO" value="<?php echo $row['MOBILENO'];?>" class="form-control"></div>
                                                            </div>
                                                            
                                  <div class="row form-group">
                                                                <div class="col col-md-2"><label for="textarea-input" class=" form-control-label">ADDRESS</label></div>
                                                                <div class="col-12 col-md-9"><textarea name="ADDRESS" id="textarea-input" rows="3"   class="form-control"><?php echo $row['ADDRESS'];?></textarea></div>
                                                            </div>
							...
							<center>	<input type="submit" value="Submit" class="btn btn-outline-success btn-lg">
															<?php 
																}
