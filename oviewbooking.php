...
<body>
        ...
        <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Booked Rooms</strong>
                            </div>
                            <div class="card-body">
	...
	<?php
			 ...
			 mysql_select_db("pga");
			$oid=$_SESSION['OID'];						
			 $query="SELECT booking_details.*, room_reg.PGNAME, room_reg.OID, user_reg.FIRSTNAME, user_reg.LASTNAME FROM booking_details INNER JOIN room_reg ON booking_details.RID = room_reg.RID INNER JOIN user_reg ON booking_details.UID = user_reg.UID WHERE booking_details.APPROVE_STATUS=0 AND room_reg.OID ='$oid'";
			...
			while($row=mysql_fetch_array($res))
			 {
				 ...
				 ?> <tbody>
			 <tr>
			  <td><font color="#FFFFFF"><?php echo $i++; ?></font></td>
			  <td><font color="#FFFFFF"><?php echo $row['PGNAME']; ?></font></td>
			  <td><font color="#FFFFFF"><?php echo $row['FIRSTNAME']; ?><?php echo $row['LASTNAME']; ?></font></td>
			  
			  <td><font color="#FFFFFF"><?php echo $row['CHECKIN_DATE']; ?></font></td>
			  <td><font color="#FFFFFF"><?php echo $row['MESSAGE']; ?></font></td>
			  <td><a href="bapprove_action.php?bid=<?php echo $row['BID']; ?>"><input type="button" class="btn btn-primary btn-flat m-b-30 m-t-30" value="APPROVE"></a></td>
			 <?php
