        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="user_index.php">USER PASSWORD CHANGE
                      <!--  <img class="align-content" src="images/logo.png" alt="">-->
                    </a>
                </div>
                <div class="login-form">
                    <form action="upasswordchange_action.php" method="post" enctype="multipart/form-data" name="passchange" onSubmit="return checkval()">
