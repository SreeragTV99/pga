    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
            ...
            <div class="card-header">
                                    <strong class="card-title" v-if="headerText"><h2 class="pb-2 display-8" align="center">PAYING GUEST ACCOMODATION</h2></strong>
                                </div>
             ...
             <div class="card">
              <div class="card-header">
			   ...
			   <div class="col-12 col-md-9">
				  ...
				  ?>
				  <!-- <input type="text" id="text-input" name="PAGETITLE" value="" class="form-control">-->
			  </div>
