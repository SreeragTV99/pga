...
<head>
	...
	function checkval()
		{
			var name=document.forms["uregform"]["FIRSTNAME"].value;
			if(name=="")
			{
			...
			var name=document.forms["uregform"]["LASTNAME"].value;
			if(name=="")
			{
			...
			var name=document.forms["uregform"]["EMAIL"].value;
		    if(name=="")
		    {
		    ...
		    var name=document.forms["uregform"]["MOBILENO"].value;
		    if(name=="")
		    {
			...
			var name=document.forms["uregform"]["ADDRESS"].value;
		    if(name=="")
		    {
			...
			var name=document.forms["uregform"]["P_PHOTO"].value;
		    if(name=="")
		    {
			...
			var name=document.forms["uregform"]["REGISTRATIONDATE"].value;
		    if(name=="")
		    {
			...
			var name=document.forms["uregform"]["PASSWORD"].value;
		    if(name=="")
		    {
        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <form action="userreg_action.php" method="post" name="uregform" onSubmit="return checkval()" enctype="multipart/form-data">
